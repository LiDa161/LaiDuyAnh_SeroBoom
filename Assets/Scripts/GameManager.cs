...
public class GameManager : MonoBehaviour
{
    ...
    void LoadLevel(int index)
    {
        ...
        SnakeController oldPlayer = FindObjectOfType<SnakeController>();
        if (oldPlayer != null)
    ...
    void AssignTilemapsToPushables()
    {
        ...
        foreach (var apple in FindObjectsOfType<MedicineManager>())
        {
            apple.tilemaps = tilemaps;
        }

        foreach (var banana in FindObjectsOfType<MedicineManager>())
        {
